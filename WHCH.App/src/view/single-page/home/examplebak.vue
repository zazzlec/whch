...
<template  >
  <div class="example"  :style="{width:'100%',height:'100%',margin:'0px',padding:'0px' }">
    ...
    <div class="l">
      ...
      <Menu :theme="'light'" :activeName="activename" ref="shop" style="width:96%;margin-top:50px" @on-select="hanldselect">
            <MenuItem name="0" key="0">
                主界面
            </MenuItem>
            <MenuItem name="1" key="1">
                锅炉状态
            </MenuItem>
            <MenuItem name="2" key="2">
                燃料数据
            </MenuItem>
            <MenuItem name="3" key="3">
                污染状态
            </MenuItem>
            <MenuItem name="5" key="5">
                堵塞状态
            </MenuItem>
      </Menu>
    ...
    <div class="r">
      ...
      <Tabs v-model="uuu" v-if="pagenow==2">
