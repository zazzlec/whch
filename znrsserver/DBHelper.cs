...
namespace SynZnrs
{
    public class DBHelper
    {
        ...
        private string m_dbs = "Data Source=10.56.250.147;Database=sg_znrs_wh;User ID=SG_ZNRS_WH;Password=SGZNRS@2021;pooling=true;CharSet=utf8;port=3306;sslmode=none";
