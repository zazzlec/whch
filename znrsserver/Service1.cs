    ...
    public partial class Service1 : ServiceBase
    {
        ...
        public static void znrs_ch()
        {
            try
            {
                ...
                List<string> arr = new List<string>();
                //获取锅炉信息
                string sql_boiler = "select Edfh,K_Name_kw,Ch_Run,Ch_EndTime,Ch_Run_kyq,Ch_EndTime_kyq,NowStatus,Ch_StartTime from dncboiler where Status=1 and IsDeleted=0 and Id=" + boilerid;
                ...
                int nowstatus = int.Parse(dt_boiler.Rows[0][6].ToString());
                DateTime dt_lastrun = DateTime.MinValue;
                if (dt_boiler.Rows[0][7] != null && dt_boiler.Rows[0][7].ToString() != "")
                {
                    dt_lastrun = DateTime.Parse(dt_boiler.Rows[0][7].ToString());
                }
