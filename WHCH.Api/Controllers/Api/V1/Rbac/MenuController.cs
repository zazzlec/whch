...
using WHCH.Api.RequestPayload.Rbac.Menu;
using WHCH.Api.ViewModels.Rbac.DncMenu;
...
namespace WHCH.Api.Controllers.Api.V1.Rbac
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class MenuController : ControllerBase
    {
        ...
        public MenuController(WHCHDbContext dbContext, IMapper mapper)
        {
