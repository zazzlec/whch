...
using WHCH.Api.RequestPayload.Rbac.Charea;
using WHCH.Api.ViewModels.Rbac.Dnccharea;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class DncchareaController : ControllerBase
    {
        ...
        public DncchareaController(WHCHDbContext dbContext, IMapper mapper)
        {
        ...
        public IActionResult Edit(DncchareaEditViewModel model)
        {
            ...
            using (_dbContext)
            {
                ...
                entity.Wrlexec_Val = model.Wrlexec_Val;
                entity.Dsl_Val = model.Dsl_Val;
                entity.Dslhigh_Val = model.Dslhigh_Val;
                entity.Dslexec_Val = model.Dslexec_Val;
                entity.Ckws_Val = model.Ckws_Val;
                entity.Ckyj_Val = model.Ckyj_Val;
        ...
        private ResponseModel UpdateIsDelete(CommonEnum.IsDeleted isDeleted, string ids)
        {
            using (_dbContext)
            {
                if (ToolService.DbType.Equals("mysql")){
                    ...
                    var sql1= string.Format("delete from  Dnccharea  WHERE id IN ({0}) and IsDeleted=1", parameterNames);
