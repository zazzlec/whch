...
using WHCH.Api.RequestPayload.Rbac.Windgroup;
using WHCH.Api.ViewModels.Rbac.Dncwindgroup;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class DncwindgroupController : ControllerBase
    {
        ...
        public DncwindgroupController(WHCHDbContext dbContext, IMapper mapper)
        {
