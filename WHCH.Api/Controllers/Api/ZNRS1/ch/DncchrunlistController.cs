...
using WHCH.Api.RequestPayload.Rbac.Chrunlist;
using WHCH.Api.ViewModels.Rbac.Dncchrunlist;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class DncchrunlistController : ControllerBase
    {
        ...
        public DncchrunlistController(WHCHDbContext dbContext, IMapper mapper)
        {
