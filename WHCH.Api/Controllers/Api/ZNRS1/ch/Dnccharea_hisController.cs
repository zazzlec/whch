...
using WHCH.Api.RequestPayload.Rbac.Charea_his;
using WHCH.Api.ViewModels.Rbac.Dnccharea_his;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class Dnccharea_hisController : ControllerBase
    {
        ...
        public Dnccharea_hisController(WHCHDbContext dbContext, IMapper mapper)
        {
