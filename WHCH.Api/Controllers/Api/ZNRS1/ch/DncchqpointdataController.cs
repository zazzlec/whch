...
using WHCH.Api.RequestPayload.Rbac.Chqpointdata;
using WHCH.Api.ViewModels.Rbac.Dncchqpointdata;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class DncchqpointdataController : ControllerBase
    {
        ...
        public DncchqpointdataController(WHCHDbContext dbContext, IMapper mapper)
        {
