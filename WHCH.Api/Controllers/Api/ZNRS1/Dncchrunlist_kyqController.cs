...
using WHCH.Api.RequestPayload.Rbac.Chrunlist_kyq;
using WHCH.Api.ViewModels.Rbac.Dncchrunlist_kyq;
...
namespace WHCH.Api.Controllers.Api.WHCH1
{
    ...
    public class Dncchrunlist_kyqController : ControllerBase
    {
        ...
        public Dncchrunlist_kyqController(WHCHDbContext dbContext, IMapper mapper)
        {
        ...
        private ResponseModel UpdateIsDelete(CommonEnum.IsDeleted isDeleted, string ids)
        {
            using (_dbContext)
            {
                if (ToolService.DbType.Equals("mysql")){
                    ...
                    var sql1= string.Format("delete from  Dncchrunlist_kyq  WHERE id IN ({0}) and IsDeleted=1", parameterNames);
